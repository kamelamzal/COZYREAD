...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_desc) || empty($product_auteur) || empty($product_dateedition) || empty($product_maisonedition) || empty($product_image) || empty($product_category)){
      ...
      $insert = "INSERT INTO bestseller(titre_book, prix_book, desc_book, image_book, auteur_book, cat_book, dateedition_book,maisonedition_book ) 
...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM bestseller WHERE Id_book = $id");
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         <h3>add product to Best Seller</h3>
...
<div class="product-display">
   <table class="product-display-table">
      ...
      <tr>
         <td><img src="img/<?php echo $row['image_book']; ?>" height="100" alt=""></td>
         <td><?php echo $row['titre_book']; ?></td>
         <td><?php echo $row['prix_book']; ?>DA</td>
         <td>

            <a href="admin_update.php?edit=<?php echo $row['Id_book']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
            <a  onclick="return confirm('are you sure you want to delete this product?')"href="admin_page.php?delete=<?php echo $row['Id_book']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
         </td>
      </tr>
   <?php } ?>
   </table>
