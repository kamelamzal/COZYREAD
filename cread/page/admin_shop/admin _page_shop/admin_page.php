...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_desc) || empty($product_auteur) || empty($product_dateedition) || empty($product_maisonedition) || empty($product_image) || empty($product_category)){
      ...
      $insert = "INSERT INTO books(book_name, book_price, book_desc, book_auteur, book_cat, book_dateedition, book_maisonedition, book_image ) 
      VALUES('$product_name', '$product_price','$product_desc', '$product_auteur', '$product_category', '$product_dateedition',  '$product_maisonedition', '$product_image' )";
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="text" name="product_desc" placeholder="enter the product decription" class="box" required>
   <input type="text" name="product_auteur" placeholder="enter  auteur " class="box" required>
   ...
   <!-- fin partie -->
   <input type="date" name="product_dateedition" placeholder="enter date of edition aaaa-mm-jj" class="box" required>
...
<div class="product-display">
   <table class="product-display-table">
      ...
      <tr>
         <td><img src="img/<?php echo $row['book_image']; ?>" height="100" alt=""></td>
         <td><?php echo $row['book_name']; ?></td>
         <td><?php echo $row['book_price']; ?> DA</td>
         <td>

            <a href="admin_update.php?edit=<?php echo $row['book_id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
            <a onclick="return confirm('are you sure you want to delet this book?')" href="admin_page.php?delete=<?php echo $row['book_id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
         </td>
      </tr>
   <?php } ?>
   </table>
