...
<head>
    ...
    <title>grand fish best seller</title>
...
//     while($fetch_product = mysqli_fetch_assoc($sql)){
    ...
    $select_products = mysqli_query($con, "SELECT * FROM `bestseller` where Id_book=$id");
...
<section id="gbook">
 ...
 <h2 > <strong> <?php echo $fetch_product['titre_book']; ?> </h2></strong>
                <h5 > <?php echo $fetch_product['auteur_book']; ?></h5>
            ...
            <input type="hidden" name="product_image" value="<?php echo $fetch_product['image_book']; ?>">
                <p class="gbook-cat"> <?php echo $fetch_product['desc_book']; ?></p>
                <p > <?php echo " <strong  style='color:#D9AAB7'>category:</strong> ". $category_book ?></p>   <!--afficher la cat-->
                
                 
        
                <div class="book-date">
        <strong><p class="book-date1"> <?php echo $fetch_product['maisonedition_book']; ?></p></strong>
          <strong>  <p class="book-date2">  <?php echo $fetch_product['dateedition_book']; ?></p></strong> 
           ...
           <a class="favori"href="" style="color:red;font-size:20px;"> <i class='bx bxs-heart checked' ></i></a>
                <p class="gbook-price"> <strong>Price:</strong> <?php echo $fetch_product['prix_book']; ?> DA</p>
