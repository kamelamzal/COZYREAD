<!-- la grand fish pour les produits de best seller j'ai utilise la base de donnes sous le nom bestseller -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>grand fish promotion</title>
...
//     while($fetch_product = mysqli_fetch_assoc($sql)){
    ...
    $select_products = mysqli_query($con, "SELECT * FROM `promotion` where promo_id=$id ");
    if(mysqli_num_rows($select_products) > 0){
       while($fetch_product = mysqli_fetch_assoc($select_products)){
        $book_catid=$fetch_product['promo_cat'];
?> 
...
<section id="gbook">
  ...
  <div class="gbook-img">
  <img src="img/<?php echo $fetch_product['promo_image']; ?>" alt=""  >

  </div>
  <div class="gbook-desc">
 <h2 > <strong> <?php echo $fetch_product['promo_name']; ?> </h2></strong>
                <h5 > <?php echo $fetch_product['promo_auteur']; ?></h5>
                <input  type="hidden" name="product_name" value="<?php echo $fetch_product['promo_name']; ?>">
            <input type="hidden" name="product_price" value="<?php echo $fetch_product['promo_newprice']; ?>">
            <input type="hidden" name="product_image" value="<?php echo $fetch_product['promo_image']; ?>">
                <p class="gbook-cat"> <?php echo $fetch_product['promo_desc']; ?></p>
                <p > <?php echo " <strong  style='color:#D9AAB7'>category:</strong> ". $category_book ?></p>   <!--afficher la cat-->
                
                 
        
                <div class="book-date">
        <strong><p class="book-date1"> <?php echo $fetch_product['promo_maisonedition']; ?></p></strong>
          <strong>  <p class="book-date2">  <?php echo $fetch_product['promo_dateedition']; ?></p></strong> 
           ...
           <a class="favori"href="" style="color:red;font-size:20px;"> <i class='bx bxs-heart checked' ></i></a>
                <p class="gbook-price"> <strong>old price:</strong><s style="color:red;"> <?php echo $fetch_product['promo_oldprice']; ?> DA</s></p>
                <p class="gbook-price"> <strong>New price:</strong> <?php echo $fetch_product['promo_newprice']; ?> DA</p>
