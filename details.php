...
<!-- la grand fish pour les produits de shop -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//     while($fetch_product = mysqli_fetch_assoc($sql)){
    ...
    $select_products = mysqli_query($con, "SELECT * FROM `books` where book_id=$id");
    if(mysqli_num_rows($select_products) > 0){
       while($fetch_product = mysqli_fetch_assoc($select_products)){
        $book_catid=$fetch_product['book_cat'];
?>
...
<section id="gbook">
 ...
 <h2 > <strong> <?php echo $fetch_product['book_name']; ?> </h2></strong>
                <h5 > <?php echo $fetch_product['book_auteur']; ?></h5>
            ...
            <input type="hidden" name="product_image" value="<?php echo $fetch_product['book_image']; ?>">
                <p class="gbook-cat"> <?php echo $fetch_product['book_desc']; ?></p>
                <p > <?php echo " <strong  style='color:#D9AAB7'>category:</strong> ". $category_book ?></p>   <!--afficher la cat-->
                
                 
        
                <div class="book-date">
        <strong><p class="book-date1"> <?php echo $fetch_product['book_maisonedition']; ?></p></strong>
          <strong>  <p class="book-date2">  <?php echo $fetch_product['book_dateedition']; ?></p></strong> 
           ...
           <a class="favori"href="" style="color:red;font-size:20px;"> <i class='bx bxs-heart checked' ></i></a>
                <p class="gbook-price"> <strong>Price:</strong> <?php echo $fetch_product['book_price']; ?> DA</p>
